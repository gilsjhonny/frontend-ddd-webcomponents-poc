...
import { CaretDownIcon, registerCaretDownIcon } from './CaretDown';

registerCaretDownIcon();

describe('CaretDownIcon', () => {
  let element: CaretDownIcon;

  beforeEach(() => {
    element = document.createElement(CaretDownIcon.componentName) as CaretDownIcon;
  ...
  describe('observedAttributes', () => {
    it('should observe the width and height attributes', () => {
      expect(CaretDownIcon.observedAttributes).toEqual(['width', 'height']);
    });
  });
});
