...
import { GridIcon, registerGridIcon } from './GridIcon';

registerGridIcon();

describe('GridIcon', () => {
  let element: GridIcon;

  beforeEach(() => {
    element = document.createElement(GridIcon.componentName) as GridIcon;
  ...
  describe('observedAttributes', () => {
    it('should observe the width and height attributes', () => {
      expect(GridIcon.observedAttributes).toEqual(['width', 'height']);
    });
  });
});
