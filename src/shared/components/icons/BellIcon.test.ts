...
import { BellIcon, registerBellIcon } from './BellIcon';

registerBellIcon();

describe('BellIcon', () => {
  let element: BellIcon;

  beforeEach(() => {
    element = document.createElement(BellIcon.componentName) as BellIcon;
  ...
  describe('observedAttributes', () => {
    it('should observe the width and height attributes', () => {
      expect(BellIcon.observedAttributes).toEqual(['width', 'height']);
    });
  });
});
